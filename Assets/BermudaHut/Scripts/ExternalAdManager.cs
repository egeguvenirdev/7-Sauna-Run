...
public class ExternalAdManager : MonoBehaviour
{

    [SerializeField] private string _gameKey = "";
    /// <summary>
    /// Merged version of all different HTML5 SDKs by all publishers.
    /// </summary>
    public static ExternalAdManager Instance;
    ...
    void Init()
    {
        ...
        {
            Debug.LogWarning("Ad SDK initialization failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    ...
    internal void ShowAd()
    {
        ...
        {
            Debug.LogWarning("Ad SDK ShowAd failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    ...
    internal void PreloadRewardedAd()
    {
        ...
        {
            Debug.LogWarning("Ad SDK Preload failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    /// <summary>
